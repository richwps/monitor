...
import de.hsos.ecs.richwps.wpsmonitor.boundary.cli.util.CommandStringParser;
 ...
 */
public class CommandLineInterface extends CommandLineInterfaceProxy {

    private final Map<String, Command> commandMap;
    private final CommandAnnotationProcessor annotationProcessor;

    public CommandLineInterface(final CommandAnnotationProcessor annotationProcessor,
